...
import { IoReorderThree ,IoClose,IoHomeSharp, IoChevronDown} from "react-icons/io5";

export default function Header() {
  const [isOpen, setIsOpen] = useState(false)

  return (
    <header className="bg-[#8B1E15] py-2 border-t-2 border-[#f45721]">
  ...
  <Link href="/" className="text-white hover:text-orange-200 transition flex items-center space-x-1">
    <IoHomeSharp />
    <span>Home</span>
  </Link>

  {/* About Link + Dropdown Arrow */}
  <Link href="/about" className="text-white hover:text-orange-200 transition flex items-center space-x-1">
    <span>About</span>
    <IoChevronDown />
  </Link>

  {/* Activities Link + Dropdown Arrow */}
  <Link href="/activities" className="text-white hover:text-orange-200 transition flex items-center space-x-1">
    <span>Activities</span>
    <IoChevronDown />
  </Link>

  {/* Donations Link + Dropdown Arrow */}
  <Link href="/donations" className="text-white hover:text-orange-200 transition flex items-center space-x-1">
    <span>Donations</span>
    <IoChevronDown />
  </Link>

  {/* Gallery Link + Dropdown Arrow */}
  <Link href="/gallery" className="text-white hover:text-orange-200 transition flex items-center space-x-1">
    <span>Gallery</span>
    <IoChevronDown />
  </Link>
  ...
  <Link href="/contact" className="text-white hover:text-orange-200 transition">
    Contact Us
          ...
          <div className="ml-4">
            <Link
              href="/donate"
              className="rounded bg-orange-500 px-4 py-2 font-semibold text-white hover:bg-orange-600 transition"
            >
              Donate Now
            </Link>
          </div>
      ...
      */}
      ...
      >
        ...
        <div className="relative w-64 bg-[#8B1E15] p-4">
          ...
          {/* Nav Links */}
          <nav className="mt-12 flex flex-col items-start space-y-4">
            <Link
              href="/"
          ...
          <div className="mt-8">
            <Link
              href="/donate"
              onClick={() => setIsOpen(false)}
              className="inline-block rounded bg-orange-500 px-4 py-2 font-semibold text-white hover:bg-orange-600 transition"
            >
              Donate Now
            </Link>
          </div>
