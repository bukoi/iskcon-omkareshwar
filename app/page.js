...
import ParallaxEffect from "@/app/ParallaxEffect.js";
import { FaUser } from "react-icons/fa";
import blog2 from "@/public/blog2.jpg";
import blog3 from "@/public/blog3.jpg";
import DonateCard from "@/app/DonateCard.js";
...
We look forward to and will be pleased to have you visit and be a part of this incredible journey of Self-realization and Krishna Consciousness!!"
      ...
      <div className="flex flex-col flex-wrap gap-6 mt-10 text-center">
        ...
        <div className="flex flex-row flex-wrap justify-center gap-4">
          <EventCard
            ...
            title={
              'Why Should You Attend "Discover Your Permanant Happiness" Seminar?'
            }
            width="w-70"
            height="h-auto"
          >
	  ...
	  <div className="flex flex-col flex-wrap gap-6 mt-10 text-center">
        ...
        <div className="flex flex-row flex-wrap justify-center gap-4">
          <DonateCard imageSrc={member} title={"Life Membership"}></DonateCard>
          <DonateCard imageSrc={nityaseva} title={"Nitya Seva"}></DonateCard>
          <DonateCard imageSrc={annadanH} title={"Annadan Seva"}></DonateCard>
        </div>
      </div>
    </div>
  );
